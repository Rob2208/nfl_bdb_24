...
In this contribution, we have developed a metric "PEP" for quantifying the value of a tackle. It allows practitioners to assess players, particularly in terms of their tackling abilities. 
However, there are a few drawbacks that need to be taken into account during the evaluation process. An important consideration is the position and defensive playing style of the teams. Cornerbacks and safeties are often more capable of making "touchdown-saving tackles", resulting in their values typically being higher. Furthermore, safeties who engage in riskier defensive strategies, such as those employed by Brian Flores, receive less support of their teammates in the backfield, which is why their metrics may be higher. 
When considering such aspects, however, the metric we have developed can serve as an additional piece of the puzzle in the overall assessment of (defensive) players, gaining practical relevance in the process of scouting players and opponents.
