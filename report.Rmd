...
<span style="color: red;">Schreiben welche plays wir rausgenommen haben und warum</span>
...
<span style="color: red;">Animation mit Dichteschätzung</span>
...
<span style="color: red;">Plot mit beiden conditional density estimates (und closest defender mit besonderer point shape oder so)</span>
...
$$
For the mapping $g$ we set up our own EP model (similar to nflfastR) based on an Xgboost architecture (Chen and Guestrin, 2016) which, after model training, can be used to calculate the expected points, based on a given yardline and the <span style="color: red;">additional features ...</span>
