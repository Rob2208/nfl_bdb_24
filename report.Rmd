...
$$
Instead of a two-step procedure, first obtaining a kernel density estimate from the individual tree predictions to then integrate numerically, we treat the tree-predictions $\hat{y}_1, \dots, \hat{y}_{1000}$ as samples from the conditional density and approximate the above expectation via the Monte Carlo estimate
$$
