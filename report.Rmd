...
$$
For the mapping $g$ we set up our own EP model (similar to nflfastR) based on an Xgboost architecture (Chen and Guestrin, 2016) which, after model training, can be used to calculate the expected points, based on a given yardline and the additional features ...
